  ...
  return (
    <div className="landing-bg">
      ...
      <section className="wrapper text-center mb-[3rem]">
        ...
        <p>
          Cortexminds Technologies LLP was founded with the goal of driving
          digital transformation by delivering advanced AI, blockchain, and
          machine learning solutions. We serve a diverse range of industries,
          ...
          <br />
          <br />
          Our mission is to empower businesses by offering a wide array of
          services, including cloud computing, data analytics, cybersecurity,
          and custom software development. We are committed to delivering
          innovative, scalable, and secure solutions that unlock new
          opportunities and foster sustainable growth for our clients.
        </p>
      </section>
      <Testimonials />
      <SolveITNeeds />
